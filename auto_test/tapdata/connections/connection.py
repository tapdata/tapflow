...
from auto_test.init.global_vars import global_lock, client_cache, system_server_conf
from auto_test.tapdata.op_object import show_tables, get_index_type, match_line, show_connections
from auto_test.tapdata.utils.ws import gen_ws_uri_with_id

from auto_test.init import global_vars
req = global_vars.req

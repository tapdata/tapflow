...
from tapshell.tapdata_cli.request import DataSourceApi
from tapshell.tapdata_cli.params.datasource import pdk_config, DATASOURCE_CONFIG

from auto_test.init.global_vars import client_cache
from auto_test.tapdata.system.ext_storage import get_default_external_storage_id
...
class DataSource:
    ...
    def save(self):
        ...
        from auto_test.tapdata.op_object import show_connections

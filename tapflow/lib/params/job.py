...
MIGRATE = {
    ...
    "syncPoints": {"type": list, "require": False, "value": {
        ...
        "dateTime": {"type": int, "require": False},
        "nodeId": {"require": True, "type": str},
        "nodeName": {"require": True, "type": str}
    }},
...
SYNC = {
    "createTime": {require: True, type: str, default: "2022-10-06T18:43:04.352+00:00"},
    "showInspectTips": {"type": bool, "require": True, "default": False},
    "planStartDateFlag": {"type": bool, "require": True, "default": False, "desc": "plan start date or not"},
    "canOpenInspect": {"type": bool, "require": True, "default": True},
    "isOpenAutoDDL": {"type": bool, "require": True, "default": False},
    "isSchedule": {"type": bool, "require": True, default: False},
    "isStopOnError": {"type": bool, "require": True, "default": True},
    "readBatchSize": {"type": int, "require": True, "default": 500},
    "shareCache": {"type": bool, "require": True, "default": False},
    "writeThreadSize": {"type": int, "require": True, "default": 8},
    "isFilter": {"type": bool, "require": True, "default": False},
    "isAutoInspect": {"type": bool, "require": True, "default": False},
    "increaseSyncInterval": {"type": int, "require": True, "default": 500},
    "autoInspect": {type: bool, require: True, default: False},
    "accessNodeProcessId": {"type": str, "require": True, "default": ""},
    "accessNodeProcessIdList": {type: list, require: True, default: []},
    "increShareReadMode": {"type": str, "require": True, "default": "STREAMING"},
    "accessNodeType": {"type": str, "require": True, "default": "AUTOMATIC_PLATFORM_ALLOCATION"},
    ...
    "processorThreadNum": {"type": int, "require": True, "default": 1},
    "shareCdcEnable": {"type": bool, "require": True, "default": False},
    "syncPoints": {"type": list, "require": False, "value": {
        "connectionId": {"require": True, "type": str},
        "connectionName": {"require": True, "type": str},
...
NODE_SOURCE = {
    ...
    "noPrimaryKeyTableSelectType": {require: True, type: str, default: "All"},
    "ddlConfiguration": {require: True, type: str, default: "FILTER"},
...
NODE_TARGET = {
    ...
    "migrateTableSelectType": {require: True, type: str, default: "all", option: ["all", "custom", "expression"]},
    "name": {require: True, type: str},
    "dmlPolicy": {require: True, type: dict, value: {
        "insertPolicy": {require: True, type: str, option: ["update_on_exists", "ignore_on_exists"], default: "update_on_exists"},
        "updatePolicy": {require: True, type: str, option: ["ignore_on_nonexists", "insert_on_nonexists"], default: "ignore_on_nonexists"},
        }, default: {
            "insertPolicy": "update_on_exists",
            "updatePolicy": "ignore_on_nonexists"
        }},
    "initialConcurrent": {require: True, type: bool, default: True},

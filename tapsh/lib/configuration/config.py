...
from tapsh.lib.login import login_with_access_code, login_with_ak_sk
from tapsh.lib.op_object import show_agents
from tapsh.lib.utils.log import logger


DEFAULT_CONFIG_PATH = os.path.join(expanduser("~"), ".tapsh/config.ini")
...
''')
    ...
    def read_configuration_from_interactive(self) -> Configuration:
        ...
        def select_version():
            ...
            print("""tapsh requires TapData Live Data Platform(LDP) cluster to run. 

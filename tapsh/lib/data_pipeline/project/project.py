...
from tapsh.lib.utils.boolean_parser import BooleanParser
from .projectInterface import ProjectInterface
from tapsh.lib.utils.log import logger
from tapsh.lib.data_pipeline.pipeline import Flow, Pipeline
...
class Project(ProjectInterface):
    ...
    def scan(self, quiet=False) -> List[Flow]:
        ...
        if not quiet:
            logger.info("{} tapsh scripts found, running in alphebetic order: ", len(self.flow_files))

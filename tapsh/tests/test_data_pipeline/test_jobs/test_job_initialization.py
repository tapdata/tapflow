...
class TestJobInitialization(BaseJobTest):
    ...
    def test_list_method(self, mock_req_get, mock_get_obj, mock_client_cache):
        ...
        with patch('tapsh.lib.backend_apis.task.TaskApi.get_task_by_id') as mock_get_task:
            ...
            # 调用list方法
            with patch('tapsh.lib.backend_apis.task.TaskApi.get_all_tasks') as mock_get_all_tasks:

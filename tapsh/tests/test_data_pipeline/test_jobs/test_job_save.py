...
class TestJobSave(BaseJobTest):
    ...
    @patch('tapsh.lib.backend_apis.task.TaskApi.create_task')
    @patch('tapsh.lib.backend_apis.task.TaskApi.update_task')
    @patch('tapsh.lib.backend_apis.task.TaskApi.confirm_task')
    @patch('tapsh.lib.op_object.get_obj')
    @patch('tapsh.lib.data_pipeline.job.client_cache', new_callable=dict)
    @patch('tapsh.lib.data_pipeline.job.system_server_conf', new_callable=dict)

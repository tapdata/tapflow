...
from tapsh.tests.test_data_pipeline.test_nodes.mock_utils import (
...
class TestBaseNode(unittest.TestCase):
    ...
    @patch('tapsh.lib.data_pipeline.base_node.req.get')
    @patch('tapsh.lib.data_pipeline.base_node.BaseNode._get_connection_and_table')
    @patch('tapsh.lib.data_pipeline.base_node.client_cache', new_callable=dict)
    ...
    @patch('tapsh.lib.data_pipeline.base_node.req.get')
    @patch('tapsh.lib.data_pipeline.base_node.BaseNode._get_connection_and_table')
    @patch('tapsh.lib.data_pipeline.base_node.ConfigCheck')
    @patch('tapsh.lib.data_pipeline.base_node.node_config', new_callable=dict)
    @patch('tapsh.lib.data_pipeline.base_node.client_cache', new_callable=dict)

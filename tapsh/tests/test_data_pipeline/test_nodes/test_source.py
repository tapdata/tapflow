...
class TestSource(unittest.TestCase):
    ...
    @patch('tapsh.lib.data_pipeline.nodes.source.show_tables')
    @patch('tapsh.lib.data_pipeline.nodes.source.req.post')
    @patch('tapsh.lib.data_pipeline.nodes.source.req.get')
    @patch('tapsh.lib.data_pipeline.nodes.source.BaseNode._get_connection_and_table')
    @patch('tapsh.lib.data_pipeline.nodes.source.client_cache', new_callable=dict)

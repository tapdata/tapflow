...
from tapsh.tests.test_data_pipeline.test_nodes.mock_utils import mock_get_responses, mock_get_responses_for_operations

class TestTypeAdjust(unittest.TestCase):
    @patch('tapsh.lib.data_pipeline.nodes.type_modification.req.get')

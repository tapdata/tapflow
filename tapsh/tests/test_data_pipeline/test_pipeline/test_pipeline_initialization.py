...
# from tapsh.lib.data_pipeline.job import JobType, Job
...
# from tapsh.lib import request

# class TestPipelineInitialization(unittest.TestCase):
#     def setUp(self):
#         # Mock client_cache
#         self.mock_client_cache_patcher = patch('tapsh.lib.cache.client_cache')
...
#         # Mock Job
#         self.mock_job_patcher = patch('tapsh.lib.data_pipeline.pipeline.Job')
...
#         # Mock Sink类
#         self.mock_sink_patcher = patch('tapsh.lib.data_pipeline.pipeline.Sink')
...
#     @patch('tapsh.lib.data_pipeline.pipeline.Job')
